...
describe('resource submissions', () => {
  ...
  test('rejectTaskSubmission: only required params', async () => {
    const responsePromise = client.tasks.submissions.rejectTaskSubmission('id', 'body');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('rejectTaskSubmission: required and optional params', async () => {
    const response = await client.tasks.submissions.rejectTaskSubmission('id', 'body');
  });
});
